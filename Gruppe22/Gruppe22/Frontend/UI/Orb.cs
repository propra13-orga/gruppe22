...
namespace Gruppe22
{
    public class Orb : UIElement
    {
        ...
        public Orb(IHandleEvent parent, SpriteBatch spriteBatch, ContentManager content, Rectangle displayRect, int max, int value, Color color)
        ...
        public Orb(IHandleEvent parent, SpriteBatch spriteBatch, ContentManager content, Rectangle displayRect, Actor actor, bool isMagic)
            : base(parent, spriteBatch, content, displayRect)
        {
