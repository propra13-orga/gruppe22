...
namespace Gruppe22
{
    class ModifyWindow : Window
    {
        ...
        /// Constructor
        /// </summary>
        public ModifyWindow(IHandleEvent parent, SpriteBatch spriteBatch, ContentManager content, Rectangle displayRect, Item item)
            : base(parent, spriteBatch, content, displayRect)
        {
            ...
            int i = 0;
            foreach (ItemEffect effect in _item.effects)
            {
