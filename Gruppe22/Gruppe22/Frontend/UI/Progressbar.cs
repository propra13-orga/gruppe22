...
namespace Gruppe22
{
    ...
    public class ProgressBar : UIElement
    {
        ...
        public ProgressBar(IHandleEvent parent, SpriteBatch spriteBatch, ContentManager content, Rectangle displayRect, ProgressStyle style = ProgressStyle.Default, int total = 100, int start = 0)
