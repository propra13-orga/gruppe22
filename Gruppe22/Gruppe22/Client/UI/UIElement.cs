...
namespace Gruppe22.Client
{
    ...
    /// 
    /// </summary>
    public class UIElement : Backend.IHandleEvent, IDisposable, IKeyHandler
    {
        ...
        {
            if ((_displayRect.Contains(Mouse.GetState().X, Mouse.GetState().Y)) && (canFocus && !_focus)) _parent.HandleEvent(false, Backend.Events.RequestFocus, this);
            return false;
        }
