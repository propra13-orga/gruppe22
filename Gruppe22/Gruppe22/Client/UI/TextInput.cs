...
, _displayRect.Top - textheight - 3 + 3 + line), color);
        ...
        public TextInput(Backend.IHandleEvent parent, SpriteBatch spriteBatch, ContentManager content, Rectangle displayRect, string label, string text, string toolTip, int inputWidth, bool canEdit)
